<template>
    <div>
        <div id="contentPage">
            <pageheading v-on:call-refresh="refreshChild" name="Miscellaneous Debit">Miscellaneous Debit</pageheading>

            <popupadd :data="data" v-on:call-refresh="refreshChild" name="Miscellaneous Debit" api="api/miscdebit">
            ...
            <datatable :refreshing="this.refresh" v-on:refreshed="childRefreshComplete" api="api/miscdebit" v-bind:objects="[{name: 'name', displayName:'Description', innerComponent:'namecomponent'},
