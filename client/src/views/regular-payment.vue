<template>
    <div>
        <div id="contentPage">
            <pageheading v-on:call-refresh="refreshChild" name="Payment">Regular Payment</pageheading>

            <popupadd :data="data" v-on:call-refresh="refreshChild" name="Regular Payment" api="api/regularpayment">
                <template v-slot:default="slotProps">
                    <namepopup v-model="slotProps.data.name" name="Description" placeholder="Phone Bill">
                    </namepopup>
            ...
            <datatable :refreshing="this.refresh" v-on:refreshed="childRefreshComplete" api="api/regularpayment" v-bind:objects="[{name: 'name', displayName:'Description', innerComponent:'namecomponent'},
